...
import 'package:agfood/item.dart';
...
class ItemsPage extends StatefulWidget {
  ...
  var items = [
    Items(
        ...
        description:
            'Siomay asli bandung enak sekali. Bumbu kacang dan kecap langsung dari Bandung.'),
    Items(
        id: 2,
        title: 'Nasi Padang',
    ...
    Items(
        ...
        description: 'Ayam eprek dengan pilihan level kepedasan.'),
    Items(
        id: 4,
        title: 'Soto Betawi',
